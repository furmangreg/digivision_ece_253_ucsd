# All of the below code is taken from Santha Lakshmi Narayana's public GitHub blog.
# https://santhalakshminarayana.github.io/blog/retinex-image-enhancement
# No credit is taken. Only minor modifications were made to parameters to fit the dataset.
